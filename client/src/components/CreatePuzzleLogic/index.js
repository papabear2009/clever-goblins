...
class CreatePuzzleLogic extends Component {
    ...
    renderButton = () => {
        ...
        if (this.state.verified === false) {
            return <div><Button variant="" id="verify" size="lg" block onClick={() => this.handleTesting()}></Button>
                <Button variant="" size="lg" className="reset" block onClick={() => this.resetDungeon()}></Button></div>
        } else if (this.state.verified === true) {
            return <div><Button variant="" id="save" size="lg" block onClick={() => this.props.stringifyDungeonMap(JSON.stringify(this.state.dungeon))}></Button>
                <Button variant="" className="reset" size="lg" block onClick={() => this.resetDungeon()}></Button></div>
        }
    }
